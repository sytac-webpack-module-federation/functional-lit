...
})({"2zBId":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "985b268574aedfbf";
"use strict";
...
const Todo = ()=>{
    ...
    const numberOfTodoItems = (0, _functionalLit.useMemo)(()=>{
    ...
    return (0, _lit.html)`
        <div>
            ...
            <ul>
                ${todos.map((todo, index)=>(0, _lit.html)`
                    <li key="${index}">
                        ${todo}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"erD49":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
//# sourceMappingURL=index.74aedfbf.js.map
